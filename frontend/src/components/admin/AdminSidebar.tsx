...
import { adminNavItems } from "./AdminContext";
        ...
        <div className="flex items-center justify-between px-1 py-2">
          {collapsed ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-brand/15 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-brand-dark dark:text-brand">
                Admin
              </span>
            </div>
          )}
